...
document.addEventListener('DOMContentLoaded', function () {
  ...
  initCounters();
  initVideoControls();
  if (typeof initContactPageForm === 'function') {
    initContactPageForm();
  }
...
function initVideoControls() {
  ...
  // Lazy load video source and autoplay when visible in viewport
  ...
  function updateMuteIcon() {
    ...
    const soundSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/></svg>`;
    muteBtn.innerHTML = video.muted ? mutedSvg : soundSvg;
  }

  function updatePlayIcon() {
    const playSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>`;
    const pauseSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>`;
    playBtn.innerHTML = video.paused ? playSvg : pauseSvg;
  }
